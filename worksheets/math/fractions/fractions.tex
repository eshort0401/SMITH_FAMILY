...
\vspace{-1em}
\item
To add or subtract fractions with different denominators, we find equivalent fractions  with a \underbar{common denominator}, meaning that the denominators of each are a \underbar{common multiple} of the originals. For example, to find 
$$\frac{1}{2}+\frac{1}{3}$$ 
...
\begin{exercises}
\item
Add the missing numbers to find $\frac{3}{4}-\frac{2}{3}$. 
\begin{center}
