...
\begin{exercises}
\item
Draw the missing lines and fill in the missing numbers to calculate $\frac{3}{4}-\frac{2}{3}$.
\begin{center}
\begin{tabular}{ccccccccccc}
\begin{tikzpicture}[scale=0.75,baseline=-0.5ex]
\fill[gray!30] (0,0) -- (0,0.8) arc (90:0:0.8cm) -- cycle;
\draw[thick] (0,0) circle (0.8cm);
\draw[thick] (0,0.8) -- (0,-0.8);
\draw[thick] (-0.8,0) -- (0.8,0);
\end{tikzpicture} & &
...
\draw[thick] (0,0) circle (0.8cm);
\end{tikzpicture} \\[3ex]
$\displaystyle\frac{3}{\rbox{4}}$ & $-$ & $\displaystyle\frac{2}{\bbox{3}}$ & $=$ & $\displaystyle\frac{3\times\bbox{3}}{\rbox{4}\times\bbox{3}}$ & $-$ & $\displaystyle\frac{2\times\rbox{4}}{\bbox{3}\times\rbox{4}}$ & $=$ & $\displaystyle\frac{\boxed{\phantom{1}}}{\boxed{\phantom{12}}}$ \\[3.5ex]
$\displaystyle\frac{3}{4}$ & $-$ & $\displaystyle\frac{2}{3}$ & $=$ & $\displaystyle\frac{\boxed{\phantom{9}}}{12}$ & $-$ & $\displaystyle\frac{\boxed{\phantom{8}}}{12}$ & $=$ & $\displaystyle\frac{\boxed{\phantom{1}}}{\boxed{\phantom{12}}}$
\end{tabular}
\end{center}
\end{exercises}
