...
\item
Similar to finding the least common multiple, we can find the greatest common factor of two numbers using prime decomposition. This time we only keep the factors in both numbers, and if the indices are different, we use the \underbar{smaller} index. For example,
$$
\begin{array}{lll}
...
$$
for all positive whole numbers $a$ and $b$. 
\end{exercises}
